...
import { UploadCloud, X, Loader2, CheckCircle2, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-brand-black text-white py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <Link href="/admin/edit" className="inline-flex items-center gap-2 text-sm text-brand-muted hover:text-brand-gold mb-6 transition-colors">
        ...
        {success && (
          <div className="mb-8 p-4 bg-brand-card border border-brand-gold rounded-2xl flex items-center space-x-3 text-brand-gold animate-in fade-in slide-in-from-top-4">
            ...
            <p className="font-medium">Vehicle successfully updated!</p>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="bg-brand-card p-6 sm:p-10 rounded-3xl shadow-2xl space-y-8 border border-gray-800">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" name="brand" required value={formData.brand} onChange={handleChange} className={inputClasses} />
            </div>
            <div>
              <label className={labelClasses}>Model</label>
              <input type="text" name="model" required value={formData.model} onChange={handleChange} className={inputClasses} />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div>
              ...
              <input type="number" name="mileage" required min="0" value={formData.mileage} onChange={handleChange} className={inputClasses} />
            </div>
            <div>
          ...
          <div>
            ...
            <input type="text" name="engineCapacity" required value={formData.engineCapacity} onChange={handleChange} className={inputClasses} />
          </div>

          <div>
            <label className={labelClasses}>Premium Description</label>
            <textarea name="description" required rows={4} value={formData.description} onChange={handleChange} className={inputClasses}></textarea>
          </div>
