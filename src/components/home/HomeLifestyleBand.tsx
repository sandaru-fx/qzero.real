  ...
  return (
    <section className="relative overflow-hidden border-y border-brand-line">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_20%_50%,rgba(212,175,55,0.14),transparent_50%)]" />
      </div>
      ...
      <div className={`relative z-10 ${SITE_SHELL} py-16 sm:py-20`}>
        <div className="max-w-2xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              href="/about"
              className="inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-bold uppercase tracking-[0.1em] text-black gold-gradient transition-transform hover:scale-[1.02]"
            >
              Our story
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-black/40 px-6 py-3 text-sm font-bold uppercase tracking-[0.1em] text-white backdrop-blur-sm transition-colors hover:border-brand-gold/50 hover:text-brand-gold"
            >
              Talk to us
            </Link>
          </div>
